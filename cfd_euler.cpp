...
int main(){
    ...
    const int Nx = 200;    //800,1600,3200     // Number of cells in x (excluding ghost cells)
    const int Ny = 100;    //400,800,1600     // Number of cells in y
    ...
    cout << "Total simulation time: " << end_time - start_time << " seconds" << endl;
    return 0;
}
